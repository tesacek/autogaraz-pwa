...
// Kompletní statická data — modely, obrázky, plné specifikace
...
export function getStaticYears(_makeId: string, modelName: string): number[] {
    const ranges: Record<string, [number, number]> = {
        ...
        'X6': [2008, 2024], 'X7': [2019, 2024], 'i4': [2021, 2024],
        'iX': [2021, 2024], 'Z4': [2002, 2024],
        // Mercedes — opravené roky
        'A-Class': [1997, 2024],
        'C-Class': [1993, 2024],
        'E-Class': [1993, 2024],
        'S-Class': [1972, 2024],
        ...
        'GLS': [2019, 2024],
        'CLA': [2013, 2024],
        // CLS W218: 2010-2018, W257 (C257): 2018-2023
        'CLS': [2004, 2023],
        // SL R129: 1989-2001, R230: 2001-2012, R231: 2012-2021, R232: 2022-
        'SL': [1989, 2024],
        'AMG GT': [2014, 2024],
        'EQS': [2021, 2024],
        'EQE': [2022, 2024],
        // Audi — správné roky výroby
        'A3': [1996, 2024], 'A4': [1994, 2024], 'A5': [2007, 2024],
        'A6': [1994, 2024], 'A7': [2010, 2024], 'A8': [1994, 2024],
        'Q3': [2011, 2024], 'Q5': [2008, 2024], 'Q7': [2005, 2024],
        'Q8': [2018, 2024], 'RS3': [2011, 2024], 'RS4': [2000, 2024],
        'RS6': [2002, 2024], 'RS7': [2013, 2024],
        // TT výroba ukončena 2023
        'TT': [1998, 2023],
...
const FULL_SPECS: Record<string, FullSpec[]> = {
    ...
    // Mercedes — pohon 4MATIC (ne Quattro, to je Audi)
    ...
    'mercedes-benz:S-Class': [
        { model_trim: 'S 500 4MATIC', model_engine_power_ps: '435', model_lkm_mixed: '9.0', model_lkm_hwy: '7.0', model_lkm_city: '11.8', model_engine_fuel: 'Benzín', model_engine_cc: '2999', model_engine_type: 'Řadový 6válec biturbo', model_engine_cyl: '6', model_engine_torque_nm: '520', model_engine_power_rpm: '6100', model_drive: 'Pohon všech kol 4MATIC', model_transmission_type: '9-st. automat', model_0_to_100_kph: '4.9', model_top_speed_kph: '250', model_fuel_cap_l: '90', model_body: 'Sedan', model_seats: '5', model_doors: '4', model_weight_kg: '2155', model_length_mm: '5289', model_width_mm: '1954', model_height_mm: '1503', model_wheelbase_mm: '3216', model_engine_position: 'Přední' },
        { model_trim: 'S 580 4MATIC', model_engine_power_ps: '503', model_lkm_mixed: '10.2', model_lkm_hwy: '8.0', model_lkm_city: '13.2', model_engine_fuel: 'Benzín', model_engine_cc: '3982', model_engine_type: 'V8 biturbo', model_engine_cyl: '8', model_engine_torque_nm: '700', model_engine_power_rpm: '5000', model_drive: 'Pohon všech kol 4MATIC', model_transmission_type: '9-st. automat', model_0_to_100_kph: '4.4', model_top_speed_kph: '250', model_fuel_cap_l: '90', model_body: 'Sedan', model_seats: '5', model_doors: '4', model_weight_kg: '2285', model_length_mm: '5289', model_width_mm: '1954', model_height_mm: '1503', model_wheelbase_mm: '3216', model_engine_position: 'Přední' },
    ...
    'mercedes-benz:G-Class': [
        { model_trim: 'G 500', model_engine_power_ps: '422', model_lkm_mixed: '13.1', model_lkm_hwy: '10.5', model_lkm_city: '17.0', model_engine_fuel: 'Benzín', model_engine_cc: '3982', model_engine_type: 'V8 biturbo', model_engine_cyl: '8', model_engine_torque_nm: '610', model_engine_power_rpm: '5000', model_drive: 'Pohon všech kol 4MATIC', model_transmission_type: '9-st. automat', model_0_to_100_kph: '5.9', model_top_speed_kph: '210', model_fuel_cap_l: '100', model_body: 'SUV', model_seats: '5', model_doors: '5', model_weight_kg: '2485', model_length_mm: '4624', model_width_mm: '1931', model_height_mm: '1969', model_wheelbase_mm: '2890', model_engine_position: 'Přední' },
        { model_trim: 'AMG G 63', model_engine_power_ps: '585', model_lkm_mixed: '14.7', model_lkm_hwy: '11.5', model_lkm_city: '19.5', model_engine_fuel: 'Benzín', model_engine_cc: '3982', model_engine_type: 'V8 biturbo', model_engine_cyl: '8', model_engine_torque_nm: '850', model_engine_power_rpm: '5500', model_drive: 'Pohon všech kol 4MATIC', model_transmission_type: '9-st. automat', model_0_to_100_kph: '4.5', model_top_speed_kph: '220', model_fuel_cap_l: '100', model_body: 'SUV', model_seats: '5', model_doors: '5', model_weight_kg: '2560', model_length_mm: '4624', model_width_mm: '1931', model_height_mm: '1969', model_wheelbase_mm: '2890', model_engine_position: 'Přední' },
    ],
    // CLS — W218 (2010-2018), C257 (2018-2023), výroba ukončena
    'mercedes-benz:CLS': [
        { model_trim: 'CLS 400 d 4MATIC', model_engine_power_ps: '340', model_lkm_mixed: '6.6', model_lkm_hwy: '5.4', model_lkm_city: '8.5', model_engine_fuel: 'Nafta', model_engine_cc: '2925', model_engine_type: 'Řadový 6válec', model_engine_cyl: '6', model_engine_torque_nm: '700', model_engine_power_rpm: '3200', model_drive: 'Pohon všech kol 4MATIC', model_transmission_type: '9-st. automat', model_0_to_100_kph: '5.1', model_top_speed_kph: '250', model_fuel_cap_l: '80', model_body: 'Kupé', model_seats: '5', model_doors: '4', model_weight_kg: '1920', model_length_mm: '4996', model_width_mm: '1896', model_height_mm: '1422', model_wheelbase_mm: '2939', model_engine_position: 'Přední' },
        { model_trim: 'CLS 450 4MATIC', model_engine_power_ps: '367', model_lkm_mixed: '8.2', model_lkm_hwy: '6.6', model_lkm_city: '10.6', model_engine_fuel: 'Benzín', model_engine_cc: '2999', model_engine_type: 'Řadový 6válec biturbo', model_engine_cyl: '6', model_engine_torque_nm: '500', model_engine_power_rpm: '5500', model_drive: 'Pohon všech kol 4MATIC', model_transmission_type: '9-st. automat', model_0_to_100_kph: '4.8', model_top_speed_kph: '250', model_fuel_cap_l: '80', model_body: 'Kupé', model_seats: '5', model_doors: '4', model_weight_kg: '1940', model_length_mm: '4996', model_width_mm: '1896', model_height_mm: '1422', model_wheelbase_mm: '2939', model_engine_position: 'Přední' },
        { model_trim: 'AMG CLS 53 4MATIC+', model_engine_power_ps: '435', model_lkm_mixed: '8.7', model_lkm_hwy: '7.0', model_lkm_city: '11.2', model_engine_fuel: 'Benzín', model_engine_cc: '2999', model_engine_type: 'Řadový 6válec biturbo + EQ Boost', model_engine_cyl: '6', model_engine_torque_nm: '520', model_engine_power_rpm: '5800', model_drive: 'Pohon všech kol 4MATIC+', model_transmission_type: '9-st. automat', model_0_to_100_kph: '4.4', model_top_speed_kph: '270', model_fuel_cap_l: '80', model_body: 'Kupé', model_seats: '5', model_doors: '4', model_weight_kg: '1980', model_length_mm: '4996', model_width_mm: '1896', model_height_mm: '1422', model_wheelbase_mm: '2939', model_engine_position: 'Přední' },
    ],
    'mercedes-benz:CLA': [
...
function buildGenericSpecs(modelName: string): FullSpec[] {
    ...
    if (isPerf) return [{
        model_trim: 'Base', model_engine_power_ps: '450', model_lkm_mixed: '10.0',
        model_lkm_hwy: '8.0', model_lkm_city: '13.0', model_engine_fuel: 'Benzín',
        model_engine_cc: '2993', model_engine_type: 'Řadový 6válec biturbo', model_engine_cyl: '6',
        model_engine_torque_nm: '600', model_engine_power_rpm: '6000',
        model_drive: 'Pohon všech kol (AWD)', model_transmission_type: '8-st. automat',
        model_0_to_100_kph: '4.2', model_top_speed_kph: '280', model_body: 'Sedan',
        model_seats: '5', model_doors: '4', model_weight_kg: '1750',
        model_length_mm: '4700', model_width_mm: '1850', model_height_mm: '1420',
        model_wheelbase_mm: '2850', model_engine_position: 'Přední', model_fuel_cap_l: '60',
    }]
    return [
        {
            model_trim: '2.0 TDI', model_engine_power_ps: '150', model_lkm_mixed: '5.2',
            model_lkm_hwy: '4.2', model_lkm_city: '6.8', model_engine_fuel: 'Nafta',
            model_engine_cc: '1968', model_engine_type: 'Řadový 4válec', model_engine_cyl: '4',
            model_engine_torque_nm: '360', model_engine_power_rpm: '3800',
            model_drive: 'Přední pohon (FWD)', model_transmission_type: '7-st. automat',
            model_0_to_100_kph: '8.5', model_top_speed_kph: '220', model_body: 'Sedan',
            model_seats: '5', model_doors: '4', model_weight_kg: '1550',
            model_length_mm: '4640', model_width_mm: '1820', model_height_mm: '1435',
            model_wheelbase_mm: '2800', model_engine_position: 'Přední', model_fuel_cap_l: '54',
        },
        {
            model_trim: '2.0 TFSI', model_engine_power_ps: '190', model_lkm_mixed: '6.8',
            model_lkm_hwy: '5.4', model_lkm_city: '8.8', model_engine_fuel: 'Benzín',
            model_engine_cc: '1984', model_engine_type: 'Řadový 4válec', model_engine_cyl: '4',
            model_engine_torque_nm: '320', model_engine_power_rpm: '4500',
            model_drive: 'Přední pohon (FWD)', model_transmission_type: '7-st. automat',
            model_0_to_100_kph: '7.2', model_top_speed_kph: '235', model_body: 'Sedan',
            model_seats: '5', model_doors: '4', model_weight_kg: '1570',
            model_length_mm: '4640', model_width_mm: '1820', model_height_mm: '1435',
            model_wheelbase_mm: '2800', model_engine_position: 'Přední', model_fuel_cap_l: '54',
        },
        {
            model_trim: '3.0 TDI / 3.0d quattro', model_engine_power_ps: '231', model_lkm_mixed: '6.0',
            model_lkm_hwy: '5.0', model_lkm_city: '7.5', model_engine_fuel: 'Nafta',
            model_engine_cc: '2967', model_engine_type: 'V6', model_engine_cyl: '6',
            model_engine_torque_nm: '500', model_engine_power_rpm: '3500',
            model_drive: 'Pohon všech kol quattro', model_transmission_type: '8-st. automat',
            model_0_to_100_kph: '6.2', model_top_speed_kph: '250', model_body: 'Sedan',
            model_seats: '5', model_doors: '4', model_weight_kg: '1680',
            model_length_mm: '4640', model_width_mm: '1820', model_height_mm: '1435',
            model_wheelbase_mm: '2800', model_engine_position: 'Přední', model_fuel_cap_l: '54',
        },
    ]
